...
CLOUDINARY_MAX_IMAGE_BYTES = int(
    os.getenv("CLOUDINARY_MAX_IMAGE_BYTES", str(10 * 1024 * 1024))
)
CLOUDINARY_MAX_IMAGE_PIXELS = int(
    os.getenv("CLOUDINARY_MAX_IMAGE_PIXELS", "25000000")
)
